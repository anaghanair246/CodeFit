...
export function NewReleasePromo() {
  return (
    <section className="mt-12 w-full pb-10">
      <div className="mx-auto max-w-4xl rounded-[40px] border border-black/5 dark:border-white/20 p-2 shadow-sm">
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-[#e88951] p-2 shadow-sm">
          {/* Subtle radial glow from center */}
          <div
            className="absolute inset-0 z-0"
            style={{
              background: "radial-gradient(ellipse 60% 40% at 50% 50%, rgba(232, 137, 81, 0.1), transparent 70%)",
            }}
          />
              ...
              <div className="flex items-center justify-center">
                <a href="/login">
                  <div className="group border-border bg-secondary/70 flex h-[64px] cursor-pointer items-center gap-2 rounded-full border p-[11px] mt-10">
                    <div className="border-border bg-[#e88951] flex h-[43px] items-center justify-center rounded-full border">
